      ...
      {positions.map((pos) => {
        ...
        return (
          <div key={pos.asset} className={`grid grid-cols-3 gap-0 rounded-xl border ${borderColor} bg-card overflow-hidden`}>
            ...
            {/* LTV Ratio */}
            <div className="px-4 py-3 border-r">
              <p className="text-xs text-muted-foreground uppercase tracking-widest mb-1">LTV Ratio</p>
            ...
            <div className="px-4 py-3">
              <p className="text-xs text-muted-foreground uppercase tracking-widest mb-1">Liquidation Risk</p>
